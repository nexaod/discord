...
export const magicRangedBasePreset = 'https://media.discordapp.net/attachments/1027186342620299315/1054092039102402631/PRESET_range-2022-12-18-1-4514.png';
...
⬥ ${Emojis.eofGreen} ${Emojis.hammer} Statius Warhammer
...
__**Pre Build**__\n
> Indicate start with ${Emojis.dbreath}. Start with ${Emojis.inciteFear} and ${Emojis.fulArrow}.\n
${Emojis.kalgScroll} + ${Emojis.nati} → ${Emojis.anticipate} → ${Emojis.resonance} → ${Emojis.prep} → ${Emojis.meteor} → ${Emojis.grico} → ${Emojis.fsoa} ${Emojis.spec} → ${Emojis.gconc} → ${Emojis.greaterChain} → ${Emojis.greaterSun} → ${Emojis.dbreath} → ${Emojis.grico} (Start fight GCD after ${Emojis.grico})\n
__**Phase 1**__\n
...
${Emojis.greaterFury} ${Emojis.dummy} → ${Emojis.magma} → ${Emojis.detonate} → ${Emojis.kalgScroll} + ${Emojis.vulnBomb} + Target Cycle ${Emojis.nex} + ${Emojis.smokecloud} + ${Emojis.detonate} → ${Emojis.omni} → ${Emojis.wildMagic} → ${Emojis.iceBarrage} ${Emojis.smokeTendril} → ${Emojis.dbreath}\n
`,
`
__**Phase 2**__\n
...
`
__**Pillars**__\n
Lure Boss → ${Emojis.ingen} + ${Emojis.hammer} → ${Emojis.deathspore} ${Emojis.grico} → ${Emojis.vulnBomb} + ${Emojis.greaterSun} → ${Emojis.divert} → ${Emojis.fsoa} ${Emojis.spec}\n
